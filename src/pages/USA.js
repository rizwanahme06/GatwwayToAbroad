    ...
    <>
        ...
        <Container maxWidth="xl" sx={{ mt: 5, display: 'flex', alignItems: 'center' }}>
          <Grid container sx={{ alignItems: "center", justifyContent: 'space-around' }}>
            <Grid item sm={4}>
              <Typography variant='h2' sx={{ color: 'gray', fontFamily: "sans-serif", fontWeight: "800", fontSize: "50px" }} >Why to Study USA</Typography>
            </Grid>
            <Grid item sm={5.2} sx={{ position: "relative" }}>
              <Typography variant='h4' sx={{ color: 'black', fontWeight: "500", fontSize: "20px" }} >Out of the top 100 universities in the world, 48 universities are from the USA. There is no doubt about the quality of education provided in the USA. But is that the only attractive thing about the country? Not at all! Here is what draws students:</Typography><br />
            </Grid>
          </Grid>
        </Container>
        ...
        {/* know more */}
          ...
          <Grid container sx={{ alignItems: "center", justifyContent: 'space-around' }}>
            <Grid item sm={3}>
              <Typography variant='h3' sx={{ color: 'grey', fontFamily: "monospace", fontWeight: "500", fontSize: "37px" }} >Everything you need for your USA Dream</Typography>
            </Grid>
